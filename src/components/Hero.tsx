...
function Hero({ onDirectWhatsApp }: HeroProps) {
        ...
        <div className="lg:col-span-6 relative h-[340px] sm:h-[450px] lg:h-[550px] w-full select-none z-0 mt-8 lg:mt-0 flex items-center justify-center lg:justify-end lg:pr-6">
          <div className="relative w-[380px] h-[450px] origin-center scale-[0.65] sm:scale-[0.85] lg:scale-100 translate-x-[40px] lg:translate-x-0 transition-all duration-200">
            ...
            >
              ...
              <h3 className="font-hero text-lg font-normal text-white mb-0.5">Spotify Family</h3>
              <p className="font-sans text-xs text-[#A0A0A0] mb-4 leading-tight">Individual Plan 12 Bulan</p>
              <span className="font-bricolage text-[#FF7A30] text-xl font-normal">Rp 45.000</span>
            </div>
            ...
            >
              ...
              <h3 className="font-hero text-lg font-normal text-obsidian mb-0.5">Netflix Premium</h3>
              <p className="font-sans text-xs text-[#8C8A87] mb-4 leading-tight">UHD 4K + Anti Screen Limit</p>
              <span className="font-bricolage text-[#FF7A30] text-xl font-normal">Rp 35.000</span>
            </div>
            ...
            >
              ...
              <div className="w-[52px] h-[52px] bg-[#0063e5] border-2 border-obsidian rounded-full mb-5 flex items-center justify-center overflow-hidden">
                <img
                  src="https://upload.wikimedia.org/wikipedia/commons/a/a4/Disney%2B_Hotstar_logo.svg"
                  alt="Disney+ Hotstar"
                  className="w-10 h-10 object-contain"
                />
              </div>
              <h3 className="font-hero text-lg font-normal text-obsidian mb-0.5">Disney+ Hotstar</h3>
              <p className="font-sans text-xs text-[#8C8A87] mb-4 leading-tight">Akun Privat 1 Bulan</p>
              <span className="font-bricolage text-[#FF7A30] text-xl font-normal">Rp 25.000</span>
            </div>
          </div>
